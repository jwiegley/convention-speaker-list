    ...
    <>
      ...
      >
        <div
          ...
          ${isVisible ? 'bg-blue-500 text-white' : 'bg-white text-gray-700 border border-gray-300'}
        ...
        >
          ...
          <span className="font-medium text-sm">{isVisible ? 'Hide' : 'Show'} Demographics</span>
        </div>
      </motion.button>
