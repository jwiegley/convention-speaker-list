...
export const endSessionValidation = [param('id').isUUID().withMessage('Invalid session ID format')];

// Validation for session ID parameter
export const sessionIdValidation = [param('id').isUUID().withMessage('Invalid session ID format')];
